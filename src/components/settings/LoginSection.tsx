    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <section>
                ...
                <div className="space-y-6 bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm">
                    <div className="flex items-center justify-between group border-b border-gray-50 pb-6 last:border-0 last:pb-0">
                    ...
                    <div className="flex items-center justify-between group">
                        ...
                        <button className="px-5 py-2.5 text-red-500 font-bold hover:bg-red-50 rounded-xl transition-all">
                            Logout
                        </button>
                    </div>
                </div>
